...
The top word in most of them is "patient". In radiology and neurology, its "left". Other ones are more related to the specialty, for example opthamology has "eye" and podiatry has "foot", which makes a lot of sense. 
